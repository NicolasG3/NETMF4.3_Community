...
int  s_CLR_RT_fJitter_Trace_Statistics         = TINYCLR_TRACE_DEFAULT(c_CLR_RT_Trace_None,c_CLR_RT_Trace_Info /*c_CLR_RT_Trace_None*/);
int  s_CLR_RT_fJitter_Trace_Compile            = TINYCLR_TRACE_DEFAULT(c_CLR_RT_Trace_None,c_CLR_RT_Trace_Info);
int  s_CLR_RT_fJitter_Trace_Invoke             = TINYCLR_TRACE_DEFAULT(c_CLR_RT_Trace_None,c_CLR_RT_Trace_Info);
int  s_CLR_RT_fJitter_Trace_Execution          = TINYCLR_TRACE_DEFAULT(c_CLR_RT_Trace_None,c_CLR_RT_Trace_Info);
#endif
