...
#ifndef THREAD_TIME_QUANTUM_MS
#define THREAD_TIME_QUANTUM_MS	20
#endif
#if THREAD_TIME_QUANTUM_MS < 1
#error "THREAD_TIME_QUANTUM_MS can not be less than 1ms"
#elif THREAD_TIME_QUANTUM_MS > 20
#error "THREAD_TIME_QUANTUM_MS can not be more than 20ms"
#endif
...
struct CLR_RT_Thread : public CLR_RT_ObjectToEvent_Destination // EVENT HEAP - NO RELOCATION -
{
    ...
    static const CLR_UINT32 c_TimeQuantum_Milliseconds = THREAD_TIME_QUANTUM_MS;
...
#define CLR_EE_DBG_EVENT_SEND( cmd, size, payload, flags ) ((g_CLR_DBG_Debuggers[ DEBUGGER_PORT_INDEX ].m_messaging != NULL) ? g_CLR_DBG_Debuggers[ DEBUGGER_PORT_INDEX ].m_messaging->SendEvent( cmd, size, (UINT8*)payload, flags ) : false)
	...
	BlockStorageDevice*					m_jitter_BlockStorageDevice;
