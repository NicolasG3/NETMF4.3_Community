...
struct BlockUsage
{
    ...
    static const UINT32 JITTER      = 0x0080;
...
public:
	...
	static const UINT32 BLOCKTYPE_JITTER     = EXECUTABLE     | RESERVED | DATATYPE_NATIVECODE  | BlockUsage::JITTER;     // Jitted code
	...
	BOOL IsJitterCode() const       { return ((RangeType & USAGE_MASK) == BlockUsage::JITTER);     }
...
struct BlockStorageList
{
    ...
    // 
    static BOOL FindDeviceForPhysicalAddress( BlockStorageDevice** pBSD, ByteAddress PhysicalAddress, ByteAddress &BlockAddress);
