...
#define OTG_GUSBCFG_TRDT	  (0xF<<10)
...
#define OTG_GINTSTS_HCTINT    (1<<25)
#define OTG_GINTSTS_PTXFE     (1<<26)
#define OTG_GINTSTS_DCINT     (1<<29)
...
#define OTG_HCFG_FSLSPCS_48MHZ	  (0x01<<0)
#define OTG_HCFG_FSLSPCS_6MHZ	  (0x02<<0)
